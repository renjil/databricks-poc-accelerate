  ...
  task {
    ...
    notebook_task {
      ...
      base_parameters = {
        ...
        schema_path     = "dbfs:/demo/autoloader/schema_customer"
        checkpoint_path = "dbfs:/demo/autoloader/checkpoint_customer"
        source_path     = "dbfs:/demo/source/customer"
  ...
  task {
    ...
    notebook_task {
      ...
      base_parameters = {
        ...
        target_catalog  = var.catalog_name
        target_database = var.de_database_name
        schema_path     = "dbfs:/demo/autoloader/schema_sales"
        checkpoint_path = "dbfs:/demo/autoloader/checkpoint_sales"
        source_path     = "dbfs:/demo/source/sales"
      }
    }
  }
  ...
  task {
    ...
    notebook_task {
      ...
      base_parameters = {
        ...
        target_catalog  = var.catalog_name
        target_database = var.de_database_name
        schema_path     = "dbfs:/demo/autoloader/schema_store"
        checkpoint_path = "dbfs:/demo/autoloader/checkpoint_store"
        source_path     = "dbfs:/demo/source/store"
      }
    }
  }
