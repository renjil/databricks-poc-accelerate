...
from src.utils.mlops.model_train import MLflowTrackingConfig
...
class ModelDeployment:
    ...
    def _get_evaluation_metric(
        self, y_true: pd.Series, y_score: pd.Series, metric: str, stage: str
    ) -> float:
        """
        ...
        eval_dict = self.cfg.model_evaluation.evaluate(
